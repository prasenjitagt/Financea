...
const CreateInvoiceForm = ({
  ...
  form: UseFormReturn<createInvoiceFormType>;
}) => {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)}>
        ...
        <section className="mt-[20px] flex justify-between">
          {/* Select Client */}
          <FormField
            control={form.control}
            name="clientId"
        ...
        <section className="mt-[33px] flex items-center space-x-2">
          ...
          {/* Simple Text */}
          <p className="text-base font-normal">This is a recurring invoice</p>
                  ...
                  >
                    ...
                    <PopoverContent className="w-auto p-0" align="start">
                      <Calendar
                        ...
                        disabled={(date) => {
                          const recurringIssueDate =
                            form.getValues("recurringIssueDate");
        ...
        <section className="mt-[33px]  space-y-4">
          <h2 className="text-xl font-medium">Invoice Items</h2>
          ...
          <div className="w-full flex justify-center ">
            <button
              ...
              className="w-[118px] flex justify-center items-center border rounded-[7px] px-[9px] py-[8px] gap-2 cursor-pointer hover:bg-slate-50"
              onClick={() =>
                append({
                  ishourly: false,
                  name: "",
            ...
            >
              <IoAddCircle size={24} className="text-[#5E84EC]" />
        ...
        <footer className="flex justify-end">
          <div className="space-x-[10px]">
            ...
            <Button
              ...
              className="bg-[#5E84EC] hover:bg-[#7895e3]"
            >
