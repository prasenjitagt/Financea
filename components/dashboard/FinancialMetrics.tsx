  ...
  useEffect(() => {
    const fetchFinancialMetrics = async () => {
      try {
        ...
        //revenue calculation
        const revenueIncDec: number = Math.abs(
        ...
        //expense calculation
        const expenseIncDec: number = parseFloat(
          Math.abs(
            currentPeriod.totalExpenses - previousPeriod.totalExpenses
          ).toFixed(2)
        );
        ...
        const profitIncDec: number = Math.abs(
          currentPeriod.totalProfitOrLoss - previousPeriod.totalProfitOrLoss
        );
