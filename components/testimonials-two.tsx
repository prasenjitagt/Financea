    ...
    <section>
      <div className="bg-gray-950 py-24">
        <div className="@container mx-auto w-full max-w-7xl px-6">
          ...
          <div className="@lg:grid-cols-2 @3xl:grid-cols-4 grid gap-6">
            {testimonials.map((testimonial, index) => (
              <div key={index}>
                <div className="bg-white/10 border-white/15 ring-foreground/10 rounded-2xl rounded-bl border  px-4 py-3 ring-1">
