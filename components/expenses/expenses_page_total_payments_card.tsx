...
export default function ExpensesPageTotalPaymentsCards({ title, expenses, description }: ExpensesPageCardPropType) {
    ...
    return (
        <Card className="min-w-[273px] ">
            <CardContent >
                <h4 className="text-xl font-normal  text-muted-foreground mb-[12px] ">
                    {title}
                </h4>
                <section className="flex justify-between mt-2 gap-9">
                    ...
                    <p className="whitespace-pre-line text-muted-foreground text-[14px]">{description}</p>
