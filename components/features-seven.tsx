...
export default function FeaturesSection() {
  return (
    <section id="features">
      <div className="py-24 ">
        <div className="max-w-xl flex flex-col pl-24 mb-12 mx-auto  ">
          <h2 className="text-5xl font-medium mb-4 ">
            Effortless Invoicing & Faster Payments
          </h2>
          <p className="text-gray-500">
            Effortlessly manage and optimize your payment processes across
            borders, ensuring secure and efficient transactions that scale with
        ...
        <div className="mx-auto w-full max-w-7xl px-6 ">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            <Card
              variant="soft"
              className="col-span-full overflow-hidden pl-6 pt-6 shadow-blue-50 border-blue-100"
            >
              <div className=" flex flex-col mt-2 gap-6">
                <h3 className="text-foreground  text-xl font-medium">
                  Easy way to track your payments
                </h3>

                <div className="mask-b-from-95% -ml-2  mr-0.5 pl-2">
                  <div className="bg-background rounded-tl-(--radius) ring-foreground/5 relative mx-auto  h-96 overflow-hidden border border-transparent  ">
                    <Image
                      src="/OverlayBlur.svg"
                      alt="app screen"
                      width="2880"
            ...
            <Card
              variant="soft"
              className="overflow-hidden p-6  shadow-blue-50 border-blue-100"
            >
            ...
            <Card
              variant="soft"
              className="group overflow-hidden px-6 pt-6  shadow-blue-50 border-blue-100"
            >
